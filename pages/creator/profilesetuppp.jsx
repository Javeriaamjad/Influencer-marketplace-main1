...
//         if (response.ok) {
//           // If the request is successful, parse the response JSON and set the user data state
//           const data = await response.json();
//           setUserinfo(data);
//           console.log("new ",data)
//         } else {
//           console.error('Faileddddd to fetch user data:', response.statusText);
//         }
//       } catch (error) {
//         console.error('Error fetching user data:', error);
//       }
...
<<<<<<< HEAD:pages/creator/profilesetup.jsx
 */
...
=======
 */
>>>>>>> origin/main:pages/creator/profilesetuppp.jsx
