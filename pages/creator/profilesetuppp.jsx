  ...
  return (
    <div className="min-h-screen linear bg-gradient-to-r from-purple-300 via-pink-200 to-black-100 animate-gradient-x">
      <div className="space-y-6 p-10">
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6 p-6 bg-gray-50 rounded-lg shadow-lg">
            <div className="md:col-span-1">
              ...
              <p className="mt-1 text-sm text-gray-500">
                🌟 Unveil Your Unique Story! 🌟 Share your personal details to
                create a profile that's as unique as you are.
              </p>
              <img
                src="/assets/social"
                alt="Your Alt Text Here"
                className="mt-4 rounded-lg shadow-md opacity-80"
              />
            </div>
            <div className="mt-5 md:mt-0 md:col-span-2">
              <div className="w-full flex gap-5 items-center justify-center px-20">
                ...
                <UploadButton
                  ...
                  className=" text-white rounded-md shadow-md transition duration-300"
                />
              </div>
              <div className="w-full flex gap-5 items-center justify-center px-20 mt-6">
                ...
                <UploadButton
                  ...
                  className=" text-white  rounded-md shadow-mdtransition duration-300"
                />
              </div>
              <form
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6 p-6 bg-gray-50 rounded-lg shadow-lg">
          <div className="md:col-span-1">
            <h3 className="text-lg font-medium leading-6 text-pink-900">
              Platforms
            </h3>
            <p className="mt-1 text-sm text-pink-600">
              Add your social media platforms and follower counts.
            </p>
          </div>
          <form onSubmit={handleContentInfo} className="md:col-span-2">
            <div className="mt-5 md:mt-0">
              {userinfo.platforms.map((platform, index) => (
                <div
                  key={index}
                  className="grid grid-cols-6 gap-6 bg-white p-4 rounded-md mb-4 transition duration-500 hover:shadow-lg"
                >
                  <div className="col-span-6 sm:col-span-3">
                    <label
        ...
        <div className="bg-gray-100 px-4 py-5 sm:rounded-lg sm:p-6 shadow-lg">
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Add your profile pictures or videos.
              </p>
            </div>
            <div className="mt-5 md:mt-0 md:col-span-2">
              <form action="#" method="POST" onSubmit={handlePackages}>
                <div className="grid grid-cols-6 gap-6">
                  {userinfo.packages.map((pack, idx) => (
                    <div
                      key={idx}
                      className="col-span-6 sm:col-span-6 border rounded p-4 mb-4 bg-white transition duration-500 hover:shadow-lg"
                    >
                      <h4 className="block text-sm font-medium text-pink-700 mb-2">
                        Package {idx + 1}
                      </h4>
                      <div className="grid grid-cols-6 gap-6">
                        <div className="col-span-6 sm:col-span-3">
                          <label
                            htmlFor={`package-platform-${idx}`}
                            className="block text-sm font-medium text-pink-700"
                          >
                            Platform
                          </label>
                          <input
                            ...
                            onChange={(e) => {
                              const updatedPackages = userinfo.packages.map(
                                (p, index) => {
                                  if (index === idx)
                                    return { ...p, platform: e.target.value };
                                  return p;
                                }
                              );
                              setUserinfo({
                        ...
                        <div className="col-span-6">
                          <label
                            htmlFor={`package-description-${idx}`}
                            className="block text-sm font-medium text-pink-700"
                          >
                            Description
                          </label>
