                    ...
                    {userinfo?.packages?.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          ></textarea>
                          {/* jdcndcdsjcjdjcdjnskkkkkkkkkccccccccccccccccccccccccccc */}
                          <div className="w-full block gap-5  items-center justify-between px-20 ">
                            <video
                              src={
                                null == userinfo ? void 0 : userinfo.bannerImage
                              }
                              width={800}
                              height={200}
                              alt=""
                            ...
                            <UploadButton
                              ...
                              onClientUploadComplete={async (res) => {
                                // Do something with the response
                                console.log("Video Files: ", res);
                                await handleProfileMedia(
                                  userinfo.email,
                                  "video",
                                  res[0].fileUrl
                                );
                                // Update userinfo state with video URL
                                setUserinfo({
                                  ...userinfo,
                                  profileVideo: res[0].fileUrl,
                                });
                              }}
                              onUploadError={(error) => {
                                // Do something with the error.
